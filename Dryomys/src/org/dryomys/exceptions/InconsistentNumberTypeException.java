...
/**
 * 
 * This Exception represent the usage of a non-consistent type (i.e. adding a Double to a Float structure).
 * Even if all the types used are allowed, inconsistencies can always arise since they can be non consistent among themselves. 
 * 
 * @author gabriele
 *
 */
public class InconsistentNumberTypeException extends Exception {
	...
	/**
	 * A more detailed constructor, reporting also information about the expected type and the type that has been actually used instead.
	 * @param actual the object actually used
